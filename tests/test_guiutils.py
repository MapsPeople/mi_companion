...
class GuiUtilsTest(unittest.TestCase):
    ...
    def testGetIcon(self):
        ...
        Tests get_icon
        """
        self.assertFalse(GuiUtils.get_icon("browser_root.svg").isNull())
    ...
    def testGetIconSvg(self):
        ...
        """
        self.assertTrue(GuiUtils.get_icon_svg("browser_root.svg"))
        self.assertIn("browser_root.svg", GuiUtils.get_icon_svg("browser_root.svg"))
    ...
    def testGetUiFilePath(self):
        ...
        """
        self.assertTrue(GuiUtils.get_ui_file_path("authorize.ui"))
        self.assertIn("authorize.ui", GuiUtils.get_ui_file_path("authorize.ui"))
